...
export const MODEL_META_DATA = [
  {
    ...
    accuracy: 2,
    details:
      'Fastest model, ideal for quick transcriptions and resource-constrained environments',
  },
  {
    name: 'Base',
    size: '~142MB',
...
export const CACHED_MODEL_META: Record<
  string,
...
> = {
  ...
  'distilbart-cnn-6-6': {
    ...
    description:
      'A distilled version of Facebook\'s BART model, fine-tuned on CNN/DailyMail news articles for abstractive summarization. Generates a short summary of your transcript. The "6-6" means 6 encoder layers + 6 decoder layers (the full BART-large has 12+12).',
  },
  'whisper-tiny': {
    subtitle: 'for transcription · fastest',
    description:
      "OpenAI's smallest Whisper model (~75 MB). Optimized for speed on resource-constrained devices; lower accuracy on accents and background noise.",
  },
  'whisper-tiny.en': {
    subtitle: 'for transcription · fastest (English only)',
    description:
      'English-only variant of Whisper Tiny. Slightly more accurate than the multilingual tiny for English speech at the same speed.',
  },
  'whisper-base': {
    subtitle: 'for transcription · fast',
    description:
      "OpenAI's Whisper base model (~142 MB). A good balance between speed and accuracy for clear English speech.",
  },
  'whisper-base.en': {
    subtitle: 'for transcription · fast (English only)',
    description:
      'English-only variant of Whisper Base. More accurate than the multilingual base for English-only content.',
  },
  'whisper-small': {
    subtitle: 'for transcription · balanced',
    description:
      "OpenAI's Whisper small model (~466 MB). Noticeably better accuracy than base, especially for accents and noisy audio, at moderate speed.",
  },
  'whisper-small.en': {
    subtitle: 'for transcription · balanced (English only)',
    description:
      'English-only variant of Whisper Small. Best accuracy-to-speed ratio for English-only use cases.',
  },
  'whisper-medium': {
    subtitle: 'for transcription · accurate',
    description:
      "OpenAI's Whisper medium model (~1.5 GB). High accuracy across languages and accents; significantly slower than small.",
  },
  'whisper-medium.en': {
    subtitle: 'for transcription · accurate (English only)',
    description:
      'English-only variant of Whisper Medium. Top accuracy for English at the cost of longer processing time.',
  },
};
