            ...
            <div className="s-pane">
              ...
              <div style={{ marginBottom: 22 }}>
                ...
                <div className="s-card-rows">
                  {(['manual', 'ask', 'auto', 'auto-stop'] as const).map(
                    (mode) => {
                      const labels = {
                        manual: 'Manual only',
                        ask: 'Ask me',
                      ...
                      return (
                        <div
                          ...
                          onClick={() =>
                            updateRecordingPref('autoRecordMode', mode)
                          }
                          onKeyDown={(e) =>
                            (e.key === 'Enter' || e.key === ' ') &&
                            updateRecordingPref('autoRecordMode', mode)
                  ...
                  <div className="s-card-rows">
                    <div className="s-row">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          A small always-on-top capsule with levels & a note
                          field.
                        </div>
                      </div>
                      <div
                    ...
                    <div className="s-row">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          Drop a timestamp you can jump back to.
                        </div>
                      </div>
                      <div
                        style={{
                ...
                <div className="s-card-rows">
                  <div className="s-row">
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        Record your mic and the audio from your speakers.
                      </div>
                    </div>
                    <div
                      style={{
                    ...
                    >
                      <SettingSwitch
                        ...
                        onChange={(v) =>
                          updateRecordingPref('systemAudioEnabled', v)
                        }
                        accent
                      />
                    </div>
                  ...
                  <div className="s-card-rows">
                    <div className="s-row">
                      ...
                      >
                        <input
                          ...
                          onChange={(e) =>
                            updateAudioPref('micGain', +e.target.value)
                          }
                    ...
                    <div className="s-row">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          Reduce keyboard clicks and background hum.
                        </div>
                      </div>
                      <div
                        style={{
                      ...
                      >
                        <SettingSwitch
                          ...
                          onChange={(v) =>
                            updateAudioPref('noiseSuppression', v)
                          }
                        />
                      </div>
                    </div>
                  ...
                  <div className="s-card-rows">
                    <div className="s-row">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          Mark each line as You or Others.
                        </div>
                      </div>
                      <div
                        style={{
                  ...
                  <ComingSoon>
                    <div className="s-row">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          Start, stop and jot a note without opening the window.
                        </div>
                      </div>
                      <div
                        style={{
          ...
          {activePane === 'transcription' && (
            <div className="s-pane">
              <div style={{ marginBottom: 20 }}>
                ...
                >
                  The on-device speech model. Everything runs locally on your
                  Mac.
                </p>
              </div>
                ...
                <div className="s-card-rows">
                  <div className="s-row">
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        Whisper is supported today. Parakeet arrives in Phase 3.
                      </div>
                    </div>
                    <div
                      style={{
                ...
                <div className="s-card-rows">
                  {MODEL_META_DATA.map((m) => (
                    <div
                      ...
                      className={`s-row s-pick${modelPrefs.selectedModel === m.model ? ' s-selected' : ''}${m.disabled ? ' s-disabled' : ''}`}
                      style={
                        m.disabled
                      ...
                      onClick={() =>
                        !m.disabled && updateModelPref('selectedModel', m.model)
                      }
                      onKeyDown={(e) =>
                        !m.disabled &&
                        (e.key === 'Enter' || e.key === ' ') &&
                    ...
                    >
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        >
                          ...
                          <span
                            style={{ fontSize: 11.5, color: 'var(--s-text2)' }}
                          >
                            Speed{' '}
                            <MeterDots
                              count={4}
                ...
                <div className="s-card-rows">
                  ...
                  <div className="s-row">
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        Leave empty to use loaded model
                      </div>
                    </div>
                    <input
                    ...
                    {cachedModels.length > 1 && (
                      <div
                        ...
                        onClick={async () => {
                          ...
                          const res =
                            await window.electronAPI.settings.model.cache.list();
                          if (res?.success) setCachedModels(res.models);
                        }}
                      >
                        <Trash2
                  ...
                  {cachePaths && (
                    ...
                    >
                      ...
                      <button
                        ...
                        onClick={() =>
                          window.electronAPI.shell.openPath(cachePaths!)
                        }
                      >
                        Reveal
                      </button>
            ...
            <div className="s-pane">
              ...
              <div className="s-hero" style={{ marginBottom: 22 }}>
                ...
                <div>
                  ...
                  >
                    Audio is transcribed on-device with a local model — no
                    cloud, no account, and no bot ever joins your meetings. Your
                  ...
                  <ComingSoon>
                    <div className="s-row">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          Keep only the text. Smallest footprint.
                        </div>
                      </div>
                      <div
                        style={{
                  ...
                  <div className="s-card-rows">
                    <div className="s-row s-row-btn">
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        >
                          All transcripts & notes as Markdown.
                        </div>
                      </div>
                      <div
                        style={{
                ...
                <div className="s-card-rows">
                  ...
                  <div className="s-row">
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        Detect when a meeting app is in a call.
                      </div>
                    </div>
                    <div
                      style={{
                  ...
                  <div className="s-row">
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      >
                        Capture the audio playing through your speakers.
                      </div>
                    </div>
                    <div
                      style={{
