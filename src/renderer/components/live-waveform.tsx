...
export type LiveWaveformProps = HTMLAttributes<HTMLDivElement> & {
  ...
  processing?: boolean;
  deviceId?: string;
  /** When set, frequency data is pulled from getExternalData() on each tick
   *  instead of an internal getUserMedia + AnalyserNode capture — for
   *  visualizing an audio source (e.g. system-audio loopback) whose
   *  MediaStream lives outside this component/window. */
  source?: 'mic' | 'external';
  getExternalData?: () => Uint8Array | null;
  barWidth?: number;
  barHeight?: number;
  barGap?: number;
  barRadius?: number;
